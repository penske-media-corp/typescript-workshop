...
class Utility {
	...
	public function get_active_posts_uncached() : array {
		...
		if (
			! empty( $option )
			&& is_array( $option )
			&& is_array( $option['tab_pmc_sponsored_posts'] ?? null )
			&& is_array( $option['tab_pmc_sponsored_posts']['pmc_sponsored_posts'] ?? null )
		) {
	...
	public function enqueue_scripts() : void {
		...
		$asset = PMC_Scripts::load_asset_data(
			dirname( __DIR__ ) . '/assets/build/index.asset.php'
		);
